...
AppWindow::AppWindow(QWidget *parent) :
    ...
    QSqlQuery queryProfile;
      ...
      queryProfile.bindValue(":id", getId());
    ...
    QSqlTableModel *tableModelPrice;
      ...
      ui->PriceDbView->setColumnWidth(0, 1);
      ui->PriceDbView->hideColumn(1);
      ui->PriceDbView->hideColumn(2);
      ui->PriceDbView->setColumnWidth(3, 90);
      ui->PriceDbView->setColumnWidth(4, 80);
      ui->PriceDbView->setColumnWidth(5, 130);
...
void AppWindow::on_ReturnBtn_clicked() {
    ...
    QSqlQuery queryAddReturnDate;
      queryAddReturnDate.prepare("UPDATE rentdatedb SET datereturn = DATE('now', 'localtime') WHERE (userid, carid) = (:userid, :carid)");
